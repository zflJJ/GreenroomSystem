  ...
  <div>
    ...
    <el-form label-position="top" label-width="80px" :model="formLabelAlign">
      <el-row :gutter="20">
        ...
        <!--<el-input  placeholder="默认分配不用填写" disabled></el-input>-->
        <!--</el-form-item>-->
        <!--</div>-->
        <!--</el-col>-->
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-form-item label="*道闸名称" prop="name">
              <el-input v-model="formLabelAlign.name" placeholder="请输入道闸名称" :maxlength=20></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-form-item label="*道闸密码" prop="password">
              <el-input v-model="formLabelAlign.password" placeholder="请输入道闸密码" :maxlength=20></el-input>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-form-item label="*服务器IP" prop="serverIp">
              <el-input v-model="formLabelAlign.serverIp" placeholder="请输入服务器IP" :maxlength=20></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-form-item label="*服务器端口号" prop="serverPort">
              <el-input v-model="formLabelAlign.serverPort" placeholder="请输入服务器端口号" :maxlength=11></el-input>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-form-item label="绑定小区" prop="parklotName">
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-form-item label="道闸厂商" prop="manufacturerName">
              <el-input v-model="formLabelAlign.manufacturerName" placeholder="请输入道闸厂商"></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-form-item label="道闸型号" prop="model">
              <el-input v-model="formLabelAlign.model" placeholder="请输入道闸型号"></el-input>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      getBarrierData(){
        console.log(123)
        this.$http.get("barrier/"+ this.$route.query.barrierId).then(res => {
          console.log(res)
          ...
          this.formLabelAlign.serverIp = data.serverIp;
          this.formLabelAlign.serverPort = data.serverPort;
      ...
      submitForm(){
        if(this.formLabelAlign.name === ''){
        ...
        }else if(this.formLabelAlign.serverIp === ''){
          this.$message.error('所有*号内容为必填');
        }else if(this.formLabelAlign.serverPort === ''){
          this.$message.error('所有*号内容为必填');
          ...
          this.$http.post('barrier/save', data).then((res) => {
            if (res.data.error_code == 2000) {
            this.$message.success('恭喜你，编辑道闸成功了');
            this.$router.go(-1);
          } else {
            ...
            console.log(err);
            this.$message.error("数据错误,请检测提交的数据");
          })
        }
      },
