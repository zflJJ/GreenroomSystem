        ...
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-form-item label="*继电器ID" prop="id">
              <el-input v-model="formLabelAlign.id" placeholder="自动分配" disabled></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="8">
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-form-item label="*继电器类型" prop="type">
              <el-select v-model="formLabelAlign.type" placeholder="出口">
                <el-option
        ...
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-form-item label="小区名称" prop="parklotName">
              <el-input v-model.trim="formLabelAlign.parklotName" placeholder="请绑定小区" disabled></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="8">
        ...
        if (this.formLabelAlign.name === '' || this.formLabelAlign.name.length > 20) {
          ...
          this.$http.post('relaymeter/save', data).then((res) => {
            if (res.data.error_code == 2000) {
              this.$message.success('恭喜你，新增继电器成功了');
              this.$router.go(-1);
            } else {
