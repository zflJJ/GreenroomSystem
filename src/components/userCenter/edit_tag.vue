    ...
    methods: {
      ...
      addTageEvent(){
        ...
        if (this.activeName1.name === ''
          ...
          dataObj.id = this.$route.query.tag.id;
          console.log(dataObj);
      ...
      getTableDatas(){
        ...
        var paramsData = this.$route.query.tag;
        this.activeName1.name = paramsData.name;
        if (paramsData.comment) this.activeName1.comment = paramsData.comment;
        if (paramsData.userType == 0) {
          this.activeName2.userType = paramsData.userType;
          if (paramsData.orderNumber) {
            this.activeName2.orderNumber = paramsData.orderNumber;
            this.check4 = false;
            this.checked4 = true;
          }
          if (paramsData.orderAmount) {
            this.activeName2.orderAmount = paramsData.orderAmount;
            this.check3 = false;
            this.checked3 = true;
          }
          if (paramsData.unsigninDays) {
            this.activeName2.unsigninDays = paramsData.unsigninDays;
            this.check2 = false;
            this.checked2 = true;
          }
          if (paramsData.startSignupTime && paramsData.endSignupTime) {
            this.value6 = [paramsData.startSignupTime, paramsData.endSignupTime];
            this.check1 = false;
            this.checked1 = true;
          }
        }else if(paramsData.userType == 1){
          this.activeName2.userType = paramsData.userType;
          if (paramsData.unsigninDays) {
            this.activeName2.unsigninDays = paramsData.unsigninDays;
            this.check2 = false;
